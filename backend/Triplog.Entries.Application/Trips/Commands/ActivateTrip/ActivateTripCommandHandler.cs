...
public sealed class ActivateTripCommandHandler(
    ITripRepository repository,
    IUnitOfWork unitOfWork,
    TimeProvider timeProvider)
    : IRequestHandler<ActivateTripCommand, Result>
{
    public async Task<Result> Handle(ActivateTripCommand request, CancellationToken cancellationToken)
    {
        ...
        var result = trip.Activate(timeProvider.GetUtcNow().UtcDateTime);
